...
function NewSuccess() {
    ...
    const handleSubmit1 = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/upload/single/img', formData, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
            ...
            showToast('اطلاعات با موفقیت آپلود شد.', 'success');
            axios.post(`http://localhost:3001/dashboard/success/add/1`, {
    ...
    const handleSubmit2 = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/upload/multiple/2', formData2, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
